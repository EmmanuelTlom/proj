...
import { PipeServicePipe } from './wow/services/pipe-service.pipe';
import { HeaderMenuComponent } from './wow/components/header-menu/header-menu.component';
import { CalendarTimeSchedulerComponent } from './wow/components/calendar-time-scheduler/calendar-time-scheduler.component';
@NgModule({
  declarations: [
    AppComponent,
    ...
    PipeServicePipe,
    HeaderMenuComponent,
    CalendarTimeSchedulerComponent
  ],
  imports: [
    HttpClientModule,
    MatButtonModule,
